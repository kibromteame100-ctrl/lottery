...
<div class="max-w-2xl space-y-5">
    ...
    <div>
        <h1 class="text-2xl font-extrabold text-gray-900 dark:text-white">Edit Expense</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">#{{ $expense->id }} — {{ $expense->title }}</p>
    </div>
