...
<div class="max-w-2xl space-y-5">
    ...
    <div>
        <h1 class="text-2xl font-extrabold text-gray-900 dark:text-white">Create Admin User</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Add a new admin account with a specific role</p>
    </div>
