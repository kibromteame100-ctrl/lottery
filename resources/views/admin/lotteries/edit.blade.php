...
<div class="max-w-2xl space-y-5">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Lottery: {{ $lottery->name }}</h1>

    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
        <form method="POST" action="{{ route('admin.lotteries.update', $lottery) }}" class="space-y-5">
            @csrf @method('PUT')
            @include('admin.lotteries._form', ['lottery' => $lottery])
